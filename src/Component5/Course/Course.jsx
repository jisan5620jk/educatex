    ...
    <section className="bg-white py-16 md:py-20 lg:py-28 relative z-10">
      <div className="Container">
        <div className="flex items-center justify-between flex-wrap gap-5">
          <div>
            <h5 className="zoom-in font-Outfit text-sm text-HeadingColor-0 uppercase flex items-center gap-3 relative z-10 before:absolute before:left-0 before:top-full before:w-[44%] md:before:w-[35%] before:h-[.5px] before:bg-gradient-to-r before:to-white before:via-PrimaryColor-0 before:from-white">
        ...
        <div className="grid-row grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 pt-[52px]">
