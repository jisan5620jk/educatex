      ...
      <div className="relative z-10">
        <div className="Container">
          <div className="text-center">
            <h5 className="zoom-in font-Outfit text-sm text-HeadingColor-0 uppercase flex items-center gap-3 justify-center relative z-10 before:absolute before:left-1/2 before:top-full before:-translate-x-1/2 before:w-[44%] md:before:w-[11%] before:h-[.5px] before:bg-gradient-to-r before:to-transparent before:via-PrimaryColor-0 before:from-transparent">
          ...
          <div className="grid-row grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-[52px]">
