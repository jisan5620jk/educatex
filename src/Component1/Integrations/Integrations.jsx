              ...
              <div>
                <div className='flex items-start gap-2 -ml-[6px]'>
                  ...
                  <div className='flex items-center -mt-1 md:-mt-3'>
                    <div className='font-Outfit font-semibold text-HeadingColor-0 text-4xl md:text-[60px] leading-10'>
                      <OnScrollCounter
                        start={0}
                        end={86}
                        duration={1000}
                    ...
                    <h6 className='font-Outfit font-semibold text-HeadingColor-0 text-4xl md:text-[60px] leading-10'>
                      %
                    </h6>
                  </div>
                </div>
