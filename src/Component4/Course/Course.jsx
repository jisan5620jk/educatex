  ...
  return (
    <div className="bg-SecondaryColor-0 py-16 md:py-20 lg:py-28 relative overflow-hidden">
      <div className="Container">
        ...
        <div className="box-row grid gap-6 md:grid-cols-1 xl:grid-cols-2 mt-8 md:mt-14">
      ...
      <div className="absolute bottom-32 right-32 hidden md:block">
        <img
          src={shape2}
          draggable={false}
          alt="Shape"
      ...
      <div className="absolute -top-[22%] -right-7 hidden md:block">
        <img
          src={shape4}
          draggable={false}
          alt="Shape"
