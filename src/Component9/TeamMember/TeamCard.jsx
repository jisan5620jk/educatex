  ...
  return (
    <div className='group relative bg-BodyBgDark6-0 rounded-[10px]'>
      ...
      <div className='bg-transparent relative transition-all duration-500 rounded-md text-center pt-3 sm:pt-7 pb-3 sm:pb-7 rounded-b-md'>
        <h5 className='font-Outfit font-semibold text-2xl sm:text-3xl text-white transition-all duration-500'>
          {teamTitle}
        </h5>
        <p className='font-OpenSans text-white text-opacity-60 transition-all duration-500 mt-1'>
          {teamDesc}
        </p>
      </div>
    </div>
