  ...
  return (
    <section className='bg-white py-16 md:py-20 lg:py-28 relative'>
      <img
        ...
        draggable={false}
        alt='Shape'
        className='absolute top-28 right-28 animate-rotational hidden lg:block'
      />
      <img
        src={shape2}
        draggable={false}
          ...
          <div className='relative'>
            ...
            <ul className='flex items-center gap-5 my-9'>
              <li className='text-center group w-full bg-PrimaryColor-0 bg-opacity-10 rounded-[20px] px-7 pt-10 pb-8 relative z-10 overflow-hidden'>
                ...
                <h5 className='font-Outfit font-medium text-xl sm:text-lg md:text-xl lg:text-lg 2xl:text-xl text-HeadingColor-0 transition-all duration-500 group-hover:text-white mt-[52px]'>
                  Student Accomodations
                </h5>
              </li>
              <li className='text-center group w-full bg-PrimaryColor2-0 bg-opacity-10 rounded-[20px] px-7 pt-10 pb-8 relative z-10 overflow-hidden'>
                <div>
                ...
                <h5 className='font-Outfit font-medium text-xl sm:text-lg md:text-xl lg:text-lg 2xl:text-xl text-HeadingColor-0 transition-all duration-500 group-hover:text-white mt-12'>
                  Gym and Sports Facilities
                </h5>
              </li>
              <li className='text-center group w-full bg-PrimaryColor3-0 bg-opacity-10 rounded-[20px] px-7 pt-10 pb-8 relative z-10 overflow-hidden'>
                <div>
