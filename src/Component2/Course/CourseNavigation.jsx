...
const CourseNavigation = () => {
  ...
  return (
    <div className='lg:h-full flex justify-center  md:justify-end lg:w-20 absolute z-10 right-1/2 translate-x-1/2 md:translate-x-0 md:right-0 top-inherit bottom-0 md:top-1/2 md:-translate-y-1/2'>
