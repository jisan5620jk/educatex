...
const CourseNavigation = () => {
  ...
  return (
    <div className='h-full flex justify-center md:justify-end w-20 absolute z-10 md:right-0 top-[76%] md:top-1/2 md:-translate-y-1/2'>
      <div className='flex md:flex-col-reverse justify-center gap-3 w-full pl-[35%] bg-BodyBg-0 h-full'>
        <button
