      ...
      <div className='Container'>
        <div className='flex flex-wrap justify-between items-center relative'>
          <div className='flex relative'>
            <div>
              <h1 className='font-Outfit font-medium text-lg leading-6 sm:text-[34px] sm:leading-[44px] md:text-[44px] md:leading-[54px] lg:text-[30px] lg:leading-[40px] xl:text-[36px] xl:leading-[46px] text-white mt-2 mb-4'>
