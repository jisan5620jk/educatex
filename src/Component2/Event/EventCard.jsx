...
const EventCard = ({
  ...
  return (
    <div className='group grid grid-cols-12 items-center gap-7 lg:gap-0 px-5 lg:px-0 py-5 md:py-8 rounded-[20px] relative before:absolute before:left-[19%] before:top-1/2 before:-translate-y-1/2 before:w-[1px] before:h-[100px]  lg:before:bg-SecondaryColor-0before:bg-opacity-10 after:absolute after:left-[57%] after:top-1/2 after:-translate-y-1/2 after:w-[1px] after:h-[100px]  lg:after:bg-SecondaryColor-0after:bg-opacity-10'>
      <div className='col-span-12 sm:col-span-5 lg:col-span-2 flex items-center lg:justify-end gap-5 lg:gap-2 xl:gap-5'>
        <div className='event-date font-Outfit font-semibold text-[80px] leading-[80px] lg:text-[50px] lg:leading-[50px] xl:text-[80px] xl:leading-[80px]'>
          <OnScrollCounter
            start={0}
            end={eventDate}
            duration={1000}
      ...
      <div className='col-span-12 sm:col-span-7 lg:col-span-4 pr-10 sm:pr-0 lg:pl-10 2xl:pl-20'>
        <Link
          to={eventUrl}
          className='event-title transition-all duration-500 font-Outfit font-semibold text-xl leading-7 sm:text-2xl md:text-[32px] md:leading-[42px] lg:text-[24px] lg:leading-[34px] xl:text-[28px] xl:leading-[38px] 2xl:text-[30px] 2xl:leading-[40px] text-HeadingColor-0 mt-2 mb-4'
        >
          {eventTitle}
        </Link>
      </div>
