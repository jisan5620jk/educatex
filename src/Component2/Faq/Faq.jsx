        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 items-start'>
          <div className='relative z-10'>
            <img
              ...
              className='mx-auto'
            />
            <div className='absolute bottom-32 left-0 px-[30px] py-5 bg-white bg-opacity-40 backdrop-filter backdrop-blur-md border-2 border-white border-opacity-40 rounded-[20px] inline-flex items-center gap-4 w-[270px] animate-wiggle'>
              <div>
                <img
                  src={icon}
                  draggable={false}
              ...
              {faqData.map((faq, index) => (
                ...
                >
                  <div className=''>
                    ...
                    >
                      <h5
                        className={`w-full font-Outfit text-xl font-medium text-SecondaryColor-0 px-[30px] py-[19px] relative z-10 before:absolute before:left-0 before:top-0 before:w-[5px] before:h-0 before:transition-all before:duration-500 before:bg-PrimaryColor-0 ${
                          activeIndex === index
                    ...
                    >
                      <p className='font-OpenSans font-medium text-TextColor2-0 pt-6 px-[30px] pb-8 mr-5'>
