...
const ProgramsNavigation = ({ swiperRef }) => {
  return (
    <div className='flex justify-center w-full absolute z-10 top-[95%] lg:top-1/2 -translate-y-1/2 left-0'>
      <div className='flex justify-center lg:justify-between gap-3 w-full'>
        <button
