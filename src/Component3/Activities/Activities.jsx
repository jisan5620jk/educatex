    ...
    <section className='py-16 md:py-20 lg:py-28 relative'>
      ...
      <div className='Container'>
        <div className='grid grid-cols-1 gap-7 lg:gap-0 lg:grid-cols-2 items-center'>
          ...
          <div className='xl:pr-8 flex justify-end'>
        ...
        <div className='grid grid-cols-3 items-center gap-x-6 gap-y-3 mt-8'>
          <div className='group bg-[url("/images/activite-bg1.png")] bg-cover bg-center bg-no-repeat flex items-start gap-7 pt-10 pl-8 pr-7 h-[160px] rounded-[20px] transition-all duration-500 relative z-10'>
            <div className='mb-6'>
              <img
                src={Icon}
                draggable='false'
            ...
            <div className='flex-1 -mt-1'>
              <Link
                to={'/service'}
                className='font-Outfit font-medium text-xl sm:text-2xl lg:text-xl xl:text-[22px] text-HeadingColor-0 transition-all duration-500'
              >
                Art Galary Visit
              </Link>
              <p className='font-OpenSans text-TextColor2-0 transition-all duration-500 w-full max-w-[270px] mt-2'>
                Explore local parks or nature trails, identifying plants,
                animals...
              </p>
            </div>
          </div>
          <div className='group bg-[url("/images/activite-bg2.png")] bg-cover bg-center bg-no-repeat flex items-start gap-7 pt-10 pl-8 pr-7 h-[160px] rounded-[20px] transition-all duration-500 relative z-10'>
            <div className='mb-6'>
              <img
                src={Icon2}
                draggable='false'
          ...
          <div className='group bg-[url("/images/activite-bg4.png")] bg-cover bg-center bg-no-repeat flex items-start gap-7 pt-10 pl-8 pr-7 h-[160px] rounded-[20px] transition-all duration-500 relative z-10'>
            <div className='mb-6'>
              <img
                src={Icon4}
                draggable='false'
          ...
          <div className='group bg-[url("/images/activite-bg5.png")] bg-cover bg-center bg-no-repeat flex items-start gap-7 pt-10 pl-8 pr-7 h-[160px] rounded-[20px] transition-all duration-500 relative z-10'>
            <div className='mb-6'>
              <img
                src={Icon5}
                draggable='false'
