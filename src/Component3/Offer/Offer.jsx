      ...
      <div className="Container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="rounded-[20px] overflow-hidden px-5 sm:px-11 lg:px-6 2xl:px-11 pt-6 sm:pt-[50px] lg:pt-5 2xl:pt-[50px] pb-7 sm:pb-[49px] lg:pb-5 xl:pb-6 2xl:pb-[49px] bg-PrimaryColor-0 bg-opacity-15 relative z-10">
            <h6 className="fade-up bg-PrimaryColor-0 bg-opacity-10 border border-PrimaryColor-0 border-opacity-30 font-Outfit text-sm text-PrimaryColor-0 px-5 py-[5px] rounded-3xl font-medium mb-4 inline-block uppercase">
              Academic
            </h6>
            ...
            <div className="absolute top-12 right-[32%] sm:right-[22%] md:right-[32%] xl:right-[28%] 2xl:right-[32%] hidden sm:block lg:hidden xl:block">
            ...
            <div className="absolute -bottom-3 -right-24 md:-right-9 lg:-right-36 xl:-right-24 2xl:-right-9 hidden sm:block">
              <img
                src={offerThumb}
                draggable={false}
                alt="Offer Image"
