  ...
  return (
    <div className="bg-[url('/images/breadcrumb-bg2.png')] bg-no-repeat bg-cover bg-center flex items-center justify-start pt-[196px] pb-[100px] relative z-10">
      <div className="Container relative">
        <div className="absolute -bottom-32 -right-10 hidden 2xl:block">
          <img
        ...
        <h1 className="font-Outfit font-semibold text-3xl sm:text-[40px] md:text-[50px] text-HeadingColor-0 capitalize">
          {breadCrumbTitle}
        </h1>
        <ul className="flex flex-col sm:flex-row gap-2 sm:gap-3 sm:items-center mt-6">
          ...
          <li>
            <button className="font-Outfit font-medium uppercase text-HeadingColor-0 text-left">
              {breadCrumbText}
            </button>
          </li>
        </ul>
        <div className="flex items-center flex-wrap gap-7 mt-14">
          ...
          {/* Divider */}
          <div className="border-r border-SecondaryColor-0 border-opacity-20 h-12 hidden sm:block"></div>
