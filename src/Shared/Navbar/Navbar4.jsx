      ...
      <div className='header-area header-sticky style-four'>
        <div className='px-2 sm:px-3 md:px-5 lg:px-2 xl:px-5 2xl:px-8 3xl:px-[58px] py-4 lg:py-0 bg-SecondaryColor-0 lg:bg-transparent border-t lg:border-t-0 lg:border-b border-white lg:border-HeadingColor-0 border-opacity-10 lg:border-opacity-10'>
          <div className='flex items-center gap-5 justify-between lg:border-t border-white border-opacity-20'>
            ...
            <div>
              <div className='header-logo 2xl:pr-20 3xl:pr-[118px]'>
                <Link
                  to={'/'}
                  title='EducateX'
                >
              ...
              <div className='header-right-box flex items-center gap-2 sm:gap-7 lg:gap-5 xl:gap-[34px]'>
                <div className='header-right-box flex items-center gap-2 sm:gap-7 lg:gap-5 xl:gap-5'>
                  ...
                  <div className='flex items-center gap-4'>
                    ...
                    <div
                      className='size-8 md:size-[46px] lg:size-9 xl:size-[46px] bg-transparent rounded-full border border-white lg:border-HeadingColor-0 border-opacity-20 lg:border-opacity-20 overflow-hidden text-white transition-all duration-500 flex items-center justify-center cursor-pointer relative z-10 before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-PrimaryColor-0 before:transition-all before:duration-500 before:rotate-180 before:scale-0 before:-z-10 hover:before:scale-100 hover:before:rotate-0 hover:text-white hover:border-PrimaryColor-0'
                      onClick={handleMenuSearchClick}
                    >
                      <button className='menu-cart text-lg md:text-[22px] lg:text-lg xl:text-2xl'>
                        <IoIosSearch />
                      </button>
                    </div>
                  </div>
                  <div className='py-[14px] md:flex items-center gap-1 hidden'>
                    <div>
                      <button
                        type='button'
                        className=' text-PrimaryColor-0 text-base transition-all duration-500 hover:text-white font-Outfit uppercase cursor-pointer'
                    ...
                    <div>
                      <button
                        type='button'
                        className='text-PrimaryColor-0 text-base transition-all duration-500 hover:text-white font-Outfit uppercase'
