...
const Navbar5 = () => {
  ...
  useEffect(() => {
    ...
    if (window.ScrollSmoother?.get()) {
      ...
      mobileOpen ? smoother.paused(true) : smoother.paused(false);
    }
  ...
  return (
    <div>
      {/* Header Top */}
      <div className="bg-SecondaryColor-0 px-2 sm:px-3 md:px-5 lg:px-10 xl:px-6 2xl:px-8 3xl:px-[170px] flex justify-between items-center relative z-50 before:absolute before:left-1/2 before:top-1/2 before:-translate-x-1/2 before:-translate-y-1/2 xl:before:w-[28%] before:h-[.5px] before:bg-gradient-to-r before:to-SecondaryColor-0 before:via-PrimaryColor-0 before:from-SecondaryColor-0">
