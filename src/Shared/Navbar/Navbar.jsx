...
const Navbar = () => {
  ...
  return (
    <div>
      {/* Header Top */}
      <div className="bg-SecondaryColor-0 px-2 sm:px-3 md:px-5 lg:px-2 xl:px-5 2xl:px-8 3xl:px-[50px] flex justify-between items-center border-b border-white/10 lg:border-b-none relative z-50">
