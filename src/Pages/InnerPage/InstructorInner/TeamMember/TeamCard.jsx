...
const TeamCard = ({
  ...
  return (
    <div className={`group relative rounded-[20px] p-3 sm:p-5 ${cardBg}`}>
      <div className="overflow-hidden rounded-[14px] relative z-10">
        <div
          className={`
      ...
      <div className="bg-transparent relative transition-all duration-500 rounded-md text-center pt-3 sm:pt-7 pb-1">
        <Link
          to={teamUrl}
          className={`font-Outfit font-medium block text-2xl text-HeadingColor-0 transition-all duration-500 ${hoverText}`}
        >
          {teamTitle}
        </Link>
        <p
