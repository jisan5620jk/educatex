  ...
  return (
    <section>
      <div className="Container">
        <div className="grid grid-cols-1 lg:grid-cols-2 md:items-center gap-7 p-4 md:p-8 rounded-2xl bg-white shadow-shades -mt-[62px] relative z-20">
          <div className="flex flex-col sm:flex-row items-center gap-7 sm:gap-5 md:gap-7">
            <div>
              <img
                src={instructorThumb}
                draggable={false}
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-7 sm:gap-3 md:gap-7">
                <div
          ...
          <div className="lg:pl-10 lg:border-l border-HeadingColor-0 border-opacity-10 inline-block">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="font-OpenSans text-[15px] text-HeadingColor-0">
