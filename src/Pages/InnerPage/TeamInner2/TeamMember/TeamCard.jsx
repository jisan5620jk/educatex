  ...
  return (
    <div className='group relative p-2 sm:p-[30px] bg-white rounded-[10px]'>
      ...
      <div className='bg-transparent relative transition-all duration-500 rounded-md text-center pt-3 sm:pt-[22px] rounded-b-md'>
        <h5 className='font-Outfit font-semibold text-2xl sm:text-[28px] text-HeadingColor-0 transition-all duration-500'>
          {teamTitle}
        </h5>
        <p className='font-OpenSans text-TextColor2-0 transition-all duration-500 mt-1'>
          {teamDesc}
        </p>
      </div>
    </div>
