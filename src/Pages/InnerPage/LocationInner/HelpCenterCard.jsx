...
const HelpCenterCard = ({
  ...
  return (
    <div className='text-center relative z-10 before:absolute before:left-0 before:bottom-0 before:w-full before:h-[80%] before:bg-white before:rounded-md before:-z-10 pb-[40px]'>
      ...
      <h5 className='font-Outfit font-semibold text-[26px] text-HeadingColor-0 mt-5 mb-[10px]'>
        {helpCenterTitle}
      </h5>
      <p className='font-OpenSans text-TextColor2-0 mb-8'>{helpCenterDesc}</p>
