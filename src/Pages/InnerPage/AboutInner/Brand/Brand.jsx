...
import brandThumb from '/images/brand-inner1.png';
import brandThumb2 from '/images/brand-inner2.png';
import brandThumb3 from '/images/brand-inner3.png';
...
const Brand = () => {
  ...
  return (
    <section className='bg-white pt-16 md:pt-20 lg:pt-[110px] pb-[78px] rounded-b-lg lg:rounded-b-2xl relative z-10'>
