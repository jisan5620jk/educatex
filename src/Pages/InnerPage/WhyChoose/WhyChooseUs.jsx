      ...
      <div className='Container'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 2xl:gap-24 lg:items-center mb-[100px]'>
          <div>
            ...
            <h1 className='font-Outfit font-bold text-[20px] text-HeadingColor-0 leading-7 sm:text-[34px] sm:leading-[44px] md:text-[44px] md:leading-[54px] lg:text-[32px] lg:leading-[42px] xl:text-[36px] xl:leading-[46px] 2xl:text-[42px] 2xl:leading-[52px] mt-[18px]'>
              The Toptech IT Services Promise
            </h1>
            <p className='font-OpenSans text-TextColor2-0 mt-3 mb-7'>
            ...
            <ul>
              <li className='flex items-center gap-3 font-OpenSans text-lg text-HeadingColor-0'>
                <FaCircle
                  size={'9'}
              ...
              <li className='flex items-center gap-3 font-OpenSans text-lg text-HeadingColor-0 mt-4'>
                <FaCircle
                  size={'9'}
                  className='text-PrimaryColor-0'
                />
