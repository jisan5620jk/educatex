        ...
        <div className='Container'>
          ...
          <div className='grid grid-cols-3 gap-[70px] mt-12'>
            <div className='col-span-3 lg:col-span-2'>
              <h2 className='font-Outfit font-bold text-3xl sm:text-4xl text-HeadingColor-0'>
              ...
              <h2 className='font-Outfit font-bold text-3xl sm:text-4xl text-HeadingColor-0 mt-[52px]'>
              ...
              <div className='grid gap-7 grid-cols-1 lg:grid-cols-1 md:grid-cols-2 items-center xl:grid-cols-2 mt-12'>
                ...
                <div>
                  ...
                  <ul className='flex flex-col gap-[14px] mt-7'>
                    <li className='flex gap-3 items-center font-OpenSans text-TextColor2-0'>
                      <FaCircleCheck
                        size={'20'}
              ...
              <h2 className='font-Outfit font-bold text-2xl md:text-[28px] text-PrimaryColor-0 mt-[44px]'>
                Competently architect intermandated deliverables client niches
                continually underwhelm
              </h2>
              <p className='font-OpenSans text-TextColor2-0 mt-5'>
