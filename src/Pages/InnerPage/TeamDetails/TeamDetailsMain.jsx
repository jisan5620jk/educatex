    ...
    <section className='bg-[url(/images/team-details-bg.jpg)] bg-no-repeat bg-center bg-cover py-28'>
      <div className='Container'>
        <div className='grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-10 lg:gap-20 2xl:gap-[140px]'>
          ...
          <div>
            <h2 className='font-Outfit font-bold text-4xl text-HeadingColor-0 mb-1'>
              Dillur Rahman
            </h2>
            <p className='font-OpenSans text-TextColor2-0'>
              Dream Land Founder & CEO
            </p>
            <p className='font-OpenSans text-TextColor2-0 mt-9 mb-10'>
            ...
            <div className='bg-BodyBg-0 py-10 px-5 2xl:px-10 rounded-md grid grid-cols-1 gap-6 sm:gap-0 sm:grid-cols-2 sm:items-center'>
              <div className='flex lg:flex-col xl:flex-row items-center lg:items-start xl:items-center gap-5'>
                ...
                <div className='flex-1'>
                  <h5 className='font-Outfit font-semibold text-xl text-HeadingColor-0 transition-all duration-500 group-hover:text-white mb-2'>
                    Call Us Anytime
                  </h5>
                  <p className='font-Outfit text-PrimaryColor-0 font-semibold md:text-2xl lg:text-xl 2xl:text-2xl transition-all duration-500 group-hover:text-white'>
                    +123 (4547) 563
                  </p>
                </div>
              </div>
              <div className='flex lg:flex-col xl:flex-row items-center lg:items-start xl:items-center gap-5'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='font-Outfit text-PrimaryColor-0 font-semibold md:text-2xl lg:text-xl 2xl:text-2x transition-all duration-500 group-hover:text-white'>
                    info@gmail.com
                  </p>
                </div>
              </div>
            ...
            <div className='flex flex-col sm:flex-row sm:items-center gap-6 my-[50px]'>
              <h5 className='font-Outfit font-semibold text-2xl text-HeadingColor-0'>
                Social Media :
              </h5>
            ...
            <div className='flex items-center gap-5'>
              ...
              <div className='flex-1'>
                <h5 className='font-Outfit font-semibold text-lg text-HeadingColor-0 transition-all duration-500 group-hover:text-white mb-1'>
                  Location
                </h5>
                <p className='font-OpenSans text-PrimaryColor-0 text-lg transition-all duration-500 group-hover:text-white'>
        ...
        <h1 className='font-Outfit font-bold text-4xl text-HeadingColor-0 mb-12 mt-28'>
          My Skills
        </h1>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[72px]'>
          <div>
            <div>
              <h6 className='font-Outfit font-medium text-lg text-TextColor2-0 pb-2'>
                Design Analytics
              </h6>
              <ProgressBar
                rect
