          ...
          <div className='grid grid-cols-3 gap-[50px]'>
            <div className='col-span-3 lg:col-span-2'>
              <img
                ...
                className='w-full'
              />
              <h2 className='font-Outfit font-bold text-2xl sm:text-4xl text-HeadingColor-0 mt-8'>
              ...
              <p className='font-OpenSans text-TextColor2-0 mt-7 mb-11'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-7'>
                <div className='flex flex-col md:flex-row lg:flex-col xl:flex-row gap-5 bg-[#f3f4f8] rounded-md px-6 py-7'>
                  ...
                  <div className='flex-1'>
                    <h6 className='font-Outfit font-semibold text-[22px] text-HeadingColor-0'>
                      Custom Software
                    </h6>
                    <p className='font-OpenSans text-TextColor2-0 mt-3'>
              ...
              <div className='bg-PrimaryColor-0 px-[42px] rounded-md py-7 flex flex-col sm:flex-row sm:items-center gap-8 mt-[62px]'>
                ...
                <div className='flex-1'>
                  <p className='font-OpenSans italic text-lg sm:text-[22px] leading-8 text-white'>
              ...
              <h2 className='font-Outfit font-bold text-2xl sm:text-3xl text-HeadingColor-0 mt-[54px]'>
                What the Benifits?
              </h2>
              <p className='font-OpenSans text-TextColor2-0 mt-6'>
                Alternative innovation to ethical network environmental
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-7 mt-9'>
                <div className='text-center group'>
                  ...
                  <div className='bg-white shadow-cases rounded inline-block pt-7 pl-4 sm:pl-8 pb-7 w-4/5 -mt-5 relative z-10'>
                    ...
                    <ul>
                      <li className='flex items-center gap-2 text-TextColor2-0 text-left font-OpenSans mb-2 lg:text-sm xl:text-base'>
                        <IoMdCheckmark className='text-PrimaryColor-0 text-xl' />
                        New Modern Equipments
                      </li>
                      <li className='flex items-center gap-2 text-TextColor2-0 text-left font-OpenSans lg:text-sm xl:text-base'>
                        <IoMdCheckmark className='text-PrimaryColor-0 text-xl' />
                        Expert’s Volunteers
                      </li>
                    </ul>
            ...
            <div className='col-span-3 lg:col-span-1'>
                ...
                <ul className='mt-8'>
                  <li>
                    <Link to={'/service_details'}>
                      <button className='w-full font-OpenSans text-left text-white transition-all duration-500 group px-7 py-4 flex items-center justify-between rounded bg-PrimaryColor-0 mb-3 overflow-hidden z-[1] relative before:absolute before:top-0 before:right-0 before:w-0 before:-z-[1] before:h-full before:bg-PrimaryColor-0 before:rounded before:transition-all before:duration-500 hover:before:w-full hover:before:left-0 hover:text-white'>
              ...
              <div className='bg-[#f3f4f8] rounded-md px-4 sm:px-8 lg:px-6 xl:px-8 pt-7 pb-4 mb-7'>
                ...
                <ul className='mt-8'>
                  <li>
                    <Link to={'/'}>
                      <button className='w-full font-OpenSans bg-SecondaryColor-0 text-left text-white transition-all duration-500 group px-7 py-4 flex items-center justify-between rounded bg-HoverColor-0 mb-3 overflow-hidden z-[1] relative before:absolute before:top-0 before:right-0 before:w-0 before:-z-[1] before:h-full before:bg-PrimaryColor-0 before:rounded before:transition-all before:duration-500 hover:before:w-full hover:before:left-0 hover:text-white'>
                        <span className='flex items-center gap-3 lg:gap-1 xl:gap-3'>
                          <BsFileEarmarkPdf
                            size={'20'}
              ...
              <div className="rounded-lg px-9 overflow-hidden bg-[url('/images/sidber-contact.png')] bg-cover bg-no-repeat bg-center py-[50px]">
                <img
                  ...
                  draggable='false'
                />
                <h6 className='font-OpenSans font-medium text-lg text-white mt-5 mb-2'>
                  Call Us Anytime
                </h6>
                <Link to={'/'}>
                  <button className='font-OpenSans font-semibold text-2xl text-white'>
                    +123 (4567) 890
                  </button>
                </Link>
                <Link to={'/'}>
                  <button className='font-OpenSans text-white flex gap-2 items-center mt-4 mb-[52px]'>
                    <MdEmail className='text-xl text-PrimaryColor-0' />
                    example@gmail.com
                  </button>
                </Link>
                <Link to={'/'}>
                  <button className='font-OpenSans text-white flex gap-2 items-center bg-PrimaryColor-0 w-full h-[58px] rounded-md justify-center z-10 relative before:absolute before:top-0 before:right-0 before:scale-0 before:-z-10 before:w-full before:h-full before:bg-SecondaryColor-0 before:rounded before:transition-all before:duration-500 hover:before:scale-100 hover:text-white'>
                    Contact Us
                    <FaArrowRight />
                  </button>
                </Link>
